    ...
    <div class="row text-center" id="shirt">
        ...
        <div class="row text-center" id="shoes" >
            ...
            <div class="row text-center" id="headphones">
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/sp5.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Zolo Headphone</h6>
                                <h6>Price :Rs 4500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/sp6.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Zolo Headphone</h6>
                                <h6>Price :Rs 4500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/sp7.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Sony Speaker</h6>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/sp8.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Airpods</h6>
